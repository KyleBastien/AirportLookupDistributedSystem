/*
  ...
  Project Name: Group Project (places_svc.c)

  Program Description: This program stores the city and state information from places2k.txt into a Trie
  Tree data structure. It stores the city/state/latitude/and longitude.
*/
