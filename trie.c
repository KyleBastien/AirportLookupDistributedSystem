...
//:: 
//:: Summary of modifcations made: modified trie nodes to store lat and
//:: lon data, added new function:TrieSearchPartial to allow searches 
//:: for partial but unique matches.
//::
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
#include <stdio.h>
#include "trie.h"
...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
//:: Creates a trie node with the provided character:key, latitude:lat 
...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
//:: Searches trie of argument:'root' for the string provided with 
//:: argument:'key'. Returns the terminating trie node if an extact 
//:: match for 'key' is found; returns NULL otherwise.
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
//:: Searches trie of argument:'root' for the string provided with 
//:: argument:'key'. Returns the terminating trie node if 'key' is a 
//:: partial match for a trie entry; returns NULL otherwise. In the 
//:: case of multiple partial matches, this function will simply 
//:: return which ever was added to the trie first.
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
//:: Searches trie of argument:'root' for the string provided with 
//:: argument:'key'. Returns the terminating trie node if 'key' is a 
//:: partial, but unique, match for a trie entry; returns NULL otherwise.
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
//:: Removes string provided with argument:key from trie of 
//:: argument:'root'.
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
